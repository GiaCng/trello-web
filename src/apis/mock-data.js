  ...
  board: {
    ...
    columns: [
      ...
      },
      {
        ...
        // Cách xử lý bog logic thư viện Dnd-kit khi Column là rỗng:
        // Phía FE sẽ tự tạo ra một cái card đặc biệt: PlaceholderCard, ko liên quan tới Backend,
        // Card đặc biệt này sẽ được ẩn ở giao diện ngươi dùng
        // Cấu trúc của cái card này để unique rất đơn giản
        // mỗi column tối đa 1 cái placeholder
