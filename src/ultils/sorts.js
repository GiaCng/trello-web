 ...
 *  xem nó nằm ở đâu trong array thứ 2 (orderArray) (là array mà mình
 *  dùng để sắp xếp) bằng cách tìm index (indexOf) rồi sẽ sắp xếp theo index đó 
 * bằng hàm sort của Javascript.
 */
